...
def run_model(cwd, working_dir, clean_space=False, **keys):
    print('-*-'*27)
    print('*** RUNNING MCTHERM MODEL IN ', working_dir)
    ...
    print('-*-'*27)
    print('*** MAKE MCTHERM MODEL')
    model_keys = keys['model']
    make_model_mctherm.setup(**model_keys)
